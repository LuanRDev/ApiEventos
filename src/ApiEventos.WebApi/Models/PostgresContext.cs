...
public partial class PostgresContext : DbContext
{
    ...
    public virtual DbSet<ConteudoEvento> ConteudoEventos { get; set; }

    public virtual DbSet<Evento> Eventos { get; set; }

    public virtual DbSet<EventosTipo> EventosTipos { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseNpgsql("User Id=postgres;Password=1078KqKaBPKk2rwn;Server=db.byslxpmznwhzjihwispj.supabase.co;Port=5432;Database=postgres");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<ConteudoEvento>(entity =>
        {
            entity.HasKey(e => e.CodigoConteudo).HasName("conteudo_eventos_pkey");

            entity.ToTable("conteudo_eventos");

            entity.Property(e => e.CodigoConteudo).HasColumnName("codigo_conteudo");
            entity.Property(e => e.CodigoEvento).HasColumnName("codigo_evento");
            entity.Property(e => e.NomeConteudo)
                .HasColumnType("character varying")
                .HasColumnName("nome_conteudo");
            entity.Property(e => e.UrlConteudo)
                .HasColumnType("character varying")
                .HasColumnName("url_conteudo");
        ...
        {
            entity.HasKey(e => e.CodigoEvento).HasName("eventos_pkey");

            entity.ToTable("eventos");

            entity.Property(e => e.CodigoEvento).HasColumnName("codigo_evento");
            entity.Property(e => e.CargaHoraria).HasColumnName("carga_horaria");
            entity.Property(e => e.DataRealizado)
                .HasDefaultValueSql("now()")
            ...
            entity.HasOne(d => d.TipoEventoNavigation).WithMany(p => p.Eventos)
                ...
                .HasConstraintName("eventos_tipo_evento_fkey");
        });

        modelBuilder.Entity<EventosTipo>(entity =>
        {
            entity.HasKey(e => e.TipoCodigo).HasName("eventos_tipos_pkey");

            entity.ToTable("eventos_tipos");

            entity.Property(e => e.TipoCodigo).HasColumnName("tipo_codigo");
        ...
        {
            entity.HasKey(e => e.CodigoParticipante).HasName("participantes_pkey");

            entity.ToTable("participantes");

            entity.Property(e => e.CodigoParticipante).HasColumnName("codigo_participante");
            entity.Property(e => e.CodigoEvento).HasColumnName("codigo_evento");
            ...
            entity.HasOne(d => d.CodigoEventoNavigation).WithMany(p => p.Participantes)
                .HasForeignKey(d => d.CodigoEvento)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("participantes_codigo_evento_fkey");
        });
        ...
        modelBuilder.Entity<RefreshToken>(entity =>
        {
            ...
            entity.HasIndex(e => e.SessionId, "refresh_token_session_id");
